                ...
                <div class="page-content">
                    <div class="container-fluid">
                      ...
                      <!-- end page title -->
                                ...
                                @endif
                                @if(session('wrongmessageee'))
                                <script>
                                    Swal.fire({
                                    position: 'top-end',
                                    icon: 'success',
                                    title: '{{session('wrongmessageee')}}',
                                    showConfirmButton: false,
                                    timer: 2000
                                    })
                                </script>
                        ...
                        @if(session('wrongmessageeeshoew'))
                                             <!-- row start  -->
                                             <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                                  ...
                                                                  <br>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center">
                                                                                <a href="{{url('')}}/orgapproved/{{$getorgdata->id}}" onclick="return confirm('Are you sure you want to approved this Orgnization ?');" style="color:green;">Yes</a>
                                                                                <br>
                                                                                <a href="{{url('')}}/orgnotapproved/{{$getorgdata->id}}" onclick="return confirm('Are you sure you want to not approved this Orgnization ?');" style="color:red;">No</a>
                                                                            
                                                                            </td>
                                                                            <td class="text-center">
                                                                              <a href="{{url('')}}/ddorgdata/{{$getorgdata->id}}" onclick="return confirm('Are you sure you want to delete this item?');"> <i class="bx bx-trash"> </i></a>
                                                                            </td>
                                                                        </tr>
                                                                                @endforeach
                                                                            @else 
